                                            ...
                                            <asp:Panel ID="grp_modificar" runat="server" Visible="false">
                                                ...
                                                <asp:Panel ID="pnl_ciudad" runat="server">
                                                    <div class="form-item">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="tb_ciudad" ValidationGroup="Name_Group" CssClass="validacion"></asp:RequiredFieldValidator>
                                                    </div>
                                                </asp:Panel>
