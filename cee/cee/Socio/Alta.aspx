...
<head>
    <style>
        ...
        .form-item {padding: 2px 10px 2px 10px;}
        .form-item-btn {padding: 20px 0px 20px 0px; text-align: center;}
        .labels {text-align: right; font: normal 12pt tahoma;}
    </style>
    <script>
                    ...
                    <td>
                        <div style="height: 150px; background: #eeeeee; font: normal 9pt tahoma; border-top: 1px #dddddd solid; border-bottom: 1px #dddddd solid; padding: 30px 40px 30px 80px; position: relative;">
                            <div style="width: 220px; float: left;">
                                ...
                                <div class="menu-item-selected">Alta Socio</div>
